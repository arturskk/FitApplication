...
public final class ExerciseService {
	...
	public final void addExercisePerformed(
		...
		if (!duplicate) {
			final FitnessUser user = userRepository.findById(userId).orElse(new FitnessUser());
			final Exercise exercise = exerciseRepository.findById(exerciseId).orElse(new Exercise());
	...
	public final void updateExercisePerformed(
		...
		final ExercisePerformed exercisePerformed = exercisePerformedRepository.findById(exercisePerformedId).orElse( new ExercisePerformed());
